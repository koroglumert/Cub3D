...
/*   Updated: 2023/09/23 19:53:53 by mkoroglu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	ft_take_directs(t_setting *set)
{
	...
	{
		set->player->dir_x = 0.99;
		set->player->plane_y = 0.66;
	}
	if (set->map->map[(int)set->player->pos_y][(int)set->player->pos_x] == 'W')
	{
		set->player->dir_x = -0.99;
		set->player->plane_y = -0.66;
	}
	if (set->map->map[(int)set->player->pos_y][(int)set->player->pos_x] == 'S')
	{
		set->player->plane_x = 0.66;
		set->player->dir_y = 0.99;
	}
